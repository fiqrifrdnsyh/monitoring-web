                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">INFO GRAPHIC SALES YOGYA</h3>
                    ...
                    <i class="fas fa-times"></i>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <p class="text-center">
                                            <strong>GRAFIK SALES 1 JANUARI - 31 DESEMBER 2022</strong>
                                        </p>
                                        <div class="card-body">
                                    <div class="chart">
                                ...
                                <!-- /.card-body -->
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <!-- /.progress-group -->
                                        <div class="progress-group" style="margin-top:30px;">
                                        
                                            <span class="progress-text">SALES MANUAL</span>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-6">
                                        <div class="description-block border-right">
                                            ...
                                            <span class="description-text">TOTAL SALES FAIL</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-4 col-6">
                                        <div class="description-block border-right">
                                            <span class="description-percentage text-warning"><i
                                                    class="fas fa-caret-left"></i> 7%</span>
                                            <h5 class="description-header">35</h5>
                                            <span class="description-text">TOTAL SALES MANUAL</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-4 col-6">
                                        <div class="description-block border-right">
                                            ...
                                            <span class="description-text">TOTAL SELISIH SALES</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
